...
- 2026-09-24 19:00 — beres, dipindah ke done. AC test di-skip atas keputusan Iyan (nol test otomatis di v1, dia verifikasi manual). Teks tiket di atas spek awal: login di `/`, admin wajib password `AUTH_ADMIN`, payload cookie `{uid, exp}` 7 hari (lihat `brainstorming.md` bagian 4).
